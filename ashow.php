			...
			<tbody>
				...
				<?php
					...
					//if(isset($_POST['submit1'])){
							...
							$displayquery = "SELECT * FROM users  JOIN person ON users.username = person.name" ;
							...
							while( $result = mysqli_fetch_array($querydisplay)){
								...
								<tr>
									...
									<td>
									<a href="deleteAssignment.php?delete=<?php echo $id;?>"><span  class="btn btn-danger btn-sm">Delete</span></a>
									</td>
								</tr>
								<?php
							}
